...
image_folders = [
   "/home/josva/olo trashh/yolov5trash-master/runs/detect/exp16/crops/Carton",
"/home/josva/olo trashh/yolov5trash-master/runs/detect/exp16/crops/Metal",
"/home/josva/olo trashh/yolov5trash-master/runs/detect/exp16/crops/Plastico"
]
...
while True:
    ...
    for i, image_folder in enumerate(image_folders):
        ...
        # Get the first (earliest modified) image file
        if image_files:
            image_path = os.path.join(image_folder, image_files[0])

            # Load the first updated image
